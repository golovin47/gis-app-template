...
import com.gis.jetpackplayground.base.BaseViewModel
...
class PeopleViewModel(
  ...
  override fun vmIntents(): Observable<PeopleStateChange> =
    getPeopleUseCase.execute(true)
      .map { people -> PeopleStateChange.PeopleReceived(people) }
  ...
  private fun handleError(e: Throwable) =
    Observable.just(PeopleStateChange.Error(e), PeopleStateChange.HideError)
